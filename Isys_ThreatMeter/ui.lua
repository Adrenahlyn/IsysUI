...
function Isys_ThreatMeter:CreateMainWindow()
  return self:FactoryProduce("MainForm", "FixedHudStratum")
end

function Isys_ThreatMeter:CreateWarningWindow()
  return self:FactoryProduce("WarningForm", "FixedHudStratumHigh")
end

function Isys_ThreatMeter:CreateOptionsWindow()
  return self:FactoryProduce("OptionsForm")
end

-- Create a list item window
function Isys_ThreatMeter:CreateItemWindow()
  return self:FactoryProduce("ListItem", self.wndItemList)
end

function Isys_ThreatMeter:FactoryProduce(strFormName, wndParent, tObject)
	local wndNew
...
ktFormDefinitions = {
  ...
  WarningForm = {
    ...
    Name = "Isys_ThreatMeterWarningForm", 
    ...
    Children = {
     {
      ...
      },
      {
        ...
        Text = "Isys_ThreatMeter Options", 
        Template = "CRB_NormalFramedThin", 
        Name = "Isys_ThreatMeterTitle", 
        TextColor = "UI_TextHoloTitle", 
        DT_CENTER = true, 
        DT_VCENTER = true, 
        IgnoreMouse = true, 
