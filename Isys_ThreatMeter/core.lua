...
-----------------------------------------------------------------------------------------------
local ADDON_NAME     = "Isys_ThreatMeter"
local CONFIG_VERSION = 1

local Isys_ThreatMeter = Apollo.GetAddon(ADDON_NAME)
...
-----------------------------------------------------------------------------------------------
function Isys_ThreatMeter:OnInitialize()
  -- slash commands
...
function Isys_ThreatMeter:OnEnable()
  self.bInCombat = GameLib.GetPlayerUnit():IsInCombat()
end

function Isys_ThreatMeter:OnConfigure()
...
function Isys_ThreatMeter:OnSaveSettings(eLevel)
...
function Isys_ThreatMeter:OnRestoreSettings(eLevel, tData)
  if eLevel ~= GameLib.CodeEnumAddonSaveLevel.Character then
    return
  end
...
-- @param cmd
-- @param args
function Isys_ThreatMeter:OnSlashCmd(cmd, args)
...
function Isys_ThreatMeter:OnClose( wndHandler, wndControl, eMouseButton )
	self.wndMain:Show(false)
	self:Warn(false)
end

function Isys_ThreatMeter:UpdateVisibility()
...
function Isys_ThreatMeter:ShouldShow()
...
function Isys_ThreatMeter:Warn(bShow)
...
-- warning is on.
function Isys_ThreatMeter:UpdateWarningStatus(nMyThreat, nTopThreat)
...
function Isys_ThreatMeter:OnTargetedByUnit()
  self:UpdateVisibility()
end

function Isys_ThreatMeter:OnUntargetedByUnit()
  self:UpdateVisibility()
end


function Isys_ThreatMeter:AddThreatUnit(tStore, unit, nThreatAmount)
...
function Isys_ThreatMeter:ValidateTargetThreatStore()
...
function Isys_ThreatMeter:OnTargetThreatListUpdated(...)
...
function Isys_ThreatMeter:UpdateGroupData()
	self.tGroupData = {}
...
function Isys_ThreatMeter:UpdateTPS()
...
function Isys_ThreatMeter:GetThreatAmount(t, nId)
...
function Isys_ThreatMeter:OnUnitEnteredCombat(unit, bInCombat)
...
function Isys_ThreatMeter:GetTargetName()
...
-- Get the target's id
function Isys_ThreatMeter:GetTargetId()
	local unitTarget = GameLib.GetTargetUnit()
	if unitTarget then
...
function Isys_ThreatMeter:UpdateDisplay(tThreatMeter)
...
function Isys_ThreatMeter:CompareDisplay(index, text)
...
function Isys_ThreatMeter:DisplayList(tListing)
...
function Isys_ThreatMeter:ResetDisplayOrder()
	self.tDisplayOrder = {}
end


function Isys_ThreatMeter:AddItem(i)
...
function Isys_ThreatMeter:DestroyItemList()
